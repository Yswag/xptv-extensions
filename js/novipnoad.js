...
async function getPlayinfo(ext) {
	...
	try {
		...
		//	.match(/decodeURIComponent\(escape\([A-Za-z]\)\)\}(.*)\)/)[1]
		//	.replace(/["\(\)]/g, "");
		//$print(data);
...
function getVkey(y, o, n, v, g, l) {
	...
	for (var i = 0, len = y.length; i < len; i++) {
		...
		for (var j = 0; j < e.length; j++)
			s = s.replace(new RegExp(e[j], 'g'), j)
		l += String.fromCharCode(_0xe31c(s, o, 10) - g)
	}
...
function _0x2b01e7(_0x12f758, _0xda9b8e) {
	...
	for (_0x1d31f3 = 0; 256 > _0x1d31f3; _0x1d31f3++) {
		_0x18815b =
			(_0x18815b +
				_0x300ace[_0x1d31f3] +
				_0xda9b8e.charCodeAt(_0x1d31f3 % _0xda9b8e.length)) %
			256
	...
	for (b = _0x18815b = _0x1d31f3 = 0; b < _0x3bf069.length; b++) {
		...
		_0xe5da02 += String.fromCharCode(
			_0x3bf069.charCodeAt(b) ^
				_0x300ace[(_0x300ace[_0x1d31f3] + _0x300ace[_0x18815b]) % 256]
		)
	}
	return _0xe5da02
}
